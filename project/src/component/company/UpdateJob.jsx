...
import { addDoc, collection, onSnapshot, Timestamp, doc, updateDoc } from "firebase/firestore"
...
export default function UpdateJob() {
  ...
  useEffect(()=>{
    const fetchData = ()=>{
        onSnapshot(doc(db,"postJob",id),(jobData)=>{
         const fillData=jobData.data()
            setTitle(fillData.title)
            setLocation(fillData.location)
            setJobType(fillData.jobType)
            setSalary(fillData.salary)
            setSkills(fillData.skills)
            setQualification(fillData.qualification)
            setExperience(fillData.experience)
            setVacancies(fillData.vacancies)
